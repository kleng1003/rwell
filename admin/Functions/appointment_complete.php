<?php
// ../Functions/appointment_complete.php
session_start();
...
if (isset($_POST['id'])) {
    ...
    $update = mysqli_query($con, "UPDATE appointments SET status = 'completed' WHERE appointment_id = '$appointment_id'");
    
    if ($update) {
        logActivity("Completed appointment", "Customer: {$appointment['customer_name']}, Date: {$appointment['appointment_date']}, ID: $appointment_id");
