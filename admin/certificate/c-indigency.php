			...
			<div class="content-wrapper">
                ...
                if (isset($_GET['id'])) {
                    ...
                    echo "<h5 style = 'text-align:center; font-size:25px; font-family:serif;'><b>OFFICE OF THE PUNONG BARANGAY</b></h5>
                        <h3 style = 'text-align:center; margin-top:30px; font-size:35px; font-family:serif; font-style:italic; text-decoration-line: underline;'><b>Certificate of Indigency</b></h3><br>";
